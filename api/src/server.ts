...
import { articulationScreenersRouter } from './routes/articulation-screeners';
import { reassessmentPlansRouter } from './routes/reassessment-plans';
import { schoolsRouter } from './routes/schools';
import { teachersRouter } from './routes/teachers';
import { caseManagersRouter } from './routes/case-managers';
import { exportRouter } from './routes/export';
import { soapNotesRouter } from './routes/soap-notes';
import { iepNotesRouter } from './routes/iep-notes';
...
app.use('/api/articulation-screeners', articulationScreenersRouter);
app.use('/api/reassessment-plans', reassessmentPlansRouter);
app.use('/api/schools', schoolsRouter);
app.use('/api/teachers', teachersRouter);
app.use('/api/case-managers', caseManagersRouter);
app.use('/api/soap-notes', soapNotesRouter);
app.use('/api/iep-notes', iepNotesRouter);
